...
class IrBuiltIns(
    ...
    @Deprecated("Use 'findBuiltInClass(FqName)'")
    ...
    fun findBuiltInClass(fqn: FqName) =
        moduleDescriptor.findClassAcrossModuleDependencies(ClassId.topLevel(fqn))
            ?: builtIns.getBuiltInClassByFqName(fqn)

    fun findBuiltInClass(fqn: FqNameUnsafe) =
        findBuiltInClass(fqn.toSafe())

    private fun findBuiltInClass(classFqn: String): ClassDescriptor =
        findBuiltInClass(FqName(classFqn))
    ...
    private val anyClassDescriptor = findBuiltInClass(KotlinBuiltIns.FQ_NAMES.any)
    ...
    private val booleanClassDescriptor = findBuiltInClass(KotlinBuiltIns.FQ_NAMES._boolean)
    @Deprecated("Descriptor-based API")
    ...
    private val charClassDescriptor = findBuiltInClass(KotlinBuiltIns.FQ_NAMES._char)
    @Deprecated("Descriptor-based API")
    val char = charClassDescriptor.defaultType
    val charType = char.toIrType()
    val charClass = charClassDescriptor.toIrSymbol()

    private val numberClassDescriptor = findBuiltInClass(KotlinBuiltIns.FQ_NAMES.number)
    @Deprecated("Descriptor-based API")
    ...
    private val nothingClassDescriptor = findBuiltInClass(KotlinBuiltIns.FQ_NAMES.nothing)
    @Deprecated("Descriptor-based API")
    ...
    private val unitClassDescriptor = findBuiltInClass(KotlinBuiltIns.FQ_NAMES.unit)
    @Deprecated("Descriptor-based API")
    val unit = unitClassDescriptor.defaultType
    val unitType = unit.toIrType()
    val unitClass = unitClassDescriptor.toIrSymbol()

    private val stringClassDescriptor = findBuiltInClass(KotlinBuiltIns.FQ_NAMES.string)
    @Deprecated("Descriptor-based API")
    ...
    private val charSequenceClassDescriptor = findBuiltInClass(KotlinBuiltIns.FQ_NAMES.charSequence)
    ...
    private val arrayClassDescriptor = findBuiltInClass(KotlinBuiltIns.FQ_NAMES.array)
    val arrayClass = arrayClassDescriptor.toIrSymbol()

    private val throwableClassDescriptor = findBuiltInClass(KotlinBuiltIns.FQ_NAMES.throwable)
    val throwableType = throwableClassDescriptor.defaultType.toIrType()
    val throwableClass = throwableClassDescriptor.toIrSymbol()

    private val kCallableClassDescriptor = findBuiltInClass(KotlinBuiltIns.FQ_NAMES.kCallable)
    val kCallableClass = kCallableClassDescriptor.toIrSymbol()

    private val kPropertyClassDescriptor = findBuiltInClass(KotlinBuiltIns.FQ_NAMES.kPropertyFqName)
